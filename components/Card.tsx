    ...
    >
          ...
          isDark 
            ...
            : visualEffect === 'liquid'
              ...
              : visualEffect === 'cyberpunk'
                ? 'from-black via-black/60 to-cyan-900/20' // Cyberpunk: Dark with cyan hint
      ...
      <div className="relative z-10 p-8 md:p-12 h-full flex flex-col justify-between">
        ...
        <div className="transform transition-transform duration-500 group-hover:-translate-y-1 group-active:-translate-y-0.5">
          ...
          <p className={`text-sm md:text-lg leading-relaxed max-w-sm font-medium transition-opacity duration-500 ${isDark ? 'text-gray-400 group-hover:text-gray-300 group-active:text-gray-300' : visualEffect === 'cyberpunk' ? 'text-cyan-100/70 group-hover:text-cyan-50' : 'text-gray-600 group-hover:text-gray-800 group-active:text-gray-800'}`}>
            {description}
          </p>
          ...
          <div className="mt-8 flex items-center overflow-hidden h-6">
             <span className={`text-xs font-semibold border-b transition-transform duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)] transform-gpu ${
               isDark ? 'border-white text-white' : visualEffect === 'cyberpunk' ? 'border-cyan-400 text-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]' : 'border-black text-black'
