  ...
  const translations = {
    ...
    en: {
      ...
      items: {
        ...
        lab: { title: 'Laboratory', desc: 'Inno features & Exams' },
      },
      support: 'Support Me',
    ...
    ko: {
      ...
      items: {
        ...
        lab: { title: '실험실', desc: '실험적 기능 및 시험' },
      },
      support: '지원하기',
    ...
    es: {
      ...
      items: {
        ...
        lab: { title: 'Laboratorio', desc: 'Pruebas y exámenes' },
      },
      support: 'Apóyame',
    ...
    fr: {
      ...
      items: {
        ...
        lab: { title: 'Laboratoire', desc: 'Fonctionnalités & examens' },
      },
    ...
    de: {
      ...
      items: {
        ...
        lab: { title: 'Laboratorium', desc: 'Features & Prüfungen' },
      },
    ...
    el: {
      ...
      items: {
        ...
        lab: { title: 'Εργαστήριο', desc: 'Δοκιμές & Εξετάσεις' },
      },
      support: 'Υποστήριξη',
