          ...
          <section className="max-w-7xl mx-auto px-6 pb-32 -mt-5 md:-mt-10 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <Card
                ...
                imageUrl="https://images.weserv.nl/?url=images.unsplash.com/photo-1536440136628-849c177e76a1&w=800&q=70&fit=cover"
              ...
              <Card
                ...
                imageUrl="https://images.weserv.nl/?url=images.unsplash.com/photo-1589829085413-56de8ae18c73&w=600&q=70&fit=cover"
              ...
              <Card
                ...
                imageUrl="https://images.weserv.nl/?url=images.unsplash.com/photo-1677442136019-21780ecad995&w=600&q=70&fit=cover"
                href="#"
                tag="COMING SOON"
                size="normal"
                theme="dark"
              ...
              />
               ...
               <Card
                ...
                imageUrl="https://images.weserv.nl/?url=images.unsplash.com/photo-1512820790803-83ca734da794&w=800&q=70&fit=cover"
                href="#"
                tag="BETA"
                size="wide"
                theme="light"
